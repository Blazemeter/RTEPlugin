...
public class RTESampler extends AbstractSampler implements TestStateListener, ThreadListener {
	...
	private static ThreadLocal<Map<String, RteProtocolClient>> connections = ThreadLocal.withInitial(HashMap::new);
	...
	private RteProtocolClient getClient() throws Exception {
		...
		RteProtocolClient client = clients.get(clientId);
