...
public class ScreenTest {
    ...
    public void shouldGetAddedFieldsAndSegmentsWhenGetSegments(){
        ...
        expectedSegments.add(new Screen.Segment(1,1,"S1: "));
        expectedSegments.add(new Screen.Field(1,5,"F1"));
        expectedSegments.add(new Screen.Segment(2,1,"S2: "));
        expectedSegments.add(new Screen.Field(2,5,"F2"));
